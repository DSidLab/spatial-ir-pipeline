...
u_rpl = pl.metrics_plot(
    sdata, table_name=list(sdata.tables.keys()), kde=False, column='n_IR_by_obs'
)
...
t_rpl = pl.metrics_plot(
    sdata, table_name=list(sdata.tables.keys()), kde=False, column="total_IR_by_obs"
)
...
pl.SubPlots(*spatial_plots, columns=len(spatial_plots) // 2, figsize=(10, 7))
```
